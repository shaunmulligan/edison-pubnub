...
eon.c = {
  ...
  create: function(options) {
    ...
    if (!self.pubnub) {
      error =
        "PubNub not found. See http://www.pubnub.com/docs/javascript/javascript-sdk.html#_where_do_i_get_the_code";
    }
    ...
    var init = function() {
      ...
      eon.c.subscribe(self.pubnub, options.channel, options.connect,
